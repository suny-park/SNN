...
from srnn_decoding_loopAttTask import * # Make sure this is the one we want!!
...
# for ss_cnt, StimStrength in enumerate(stim_strengths): 
    ...
    init_params = {'rndSeed' : rndSeed, 'N_trials' : N_trials, 'S_N_neuron' : S_N_neuron, 'S_N_pools' : S_N_pools, 
                  ...
                  'shiftStep':shiftStep, 'attStimShift':attStimShift}
    ...
    # Run the sims
    #-------------------------                    
    S_fr_avg_loc, label_stim_loc, label_pool_loc, label_trial_loc, S_fr_avg_main, label_stim_main, label_trial_main = M.run_sim_rand()
    #fn_decoding = 'sim_decoding/FBA_decoding_Rep0.npz'
    #fn_decoding = 'FBA_decoding_shift_Rep'+str(rep)+'.npz'
    fn_decoding = 'FBA_decoding_shiftStep32_Rep'+str(rep)+'.npz'
